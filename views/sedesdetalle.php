...
<div class="contenido_sedesdetalle">
    ...
    <div class="">
        <div class="row">
            ...
            <div class="col-md-4">
                <img src='img/docs.jpg' class='' style='border-radius: 10px;width: 100%;height: 19em; object-fit: cover; object-position: center center;'>
    
            </div>
            <div class="col-md-1"></div>
            <div class="col-md-5" style="border: 1px solid #c5c5c5; border-radius: 10px;">
                <div class="mt-4 mb-4">
    ...
    <div class="servicios__content">
        <div class="servicios__text">
            <div class="servicios__text__title">
                <h3 style="font-weight: bold; color: #055bb7; padding-top: 5px; padding-left: 3em;">Servicios:</h3>
            </div>
