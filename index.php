        ...
        <div  class="align-items-center navbar-center justify-content-end">
          <nav id="navbar" class="navbar">
            <ul class="list-left">
              ...
              <li><a class="nav-link scrollto" href="index.php?view=home#sedes">Sedes</a></li>
              ...
              <li class="dropdown"><a href="#events"><span>Novedades</span><i class="bi bi-chevron-down"></i></a>
                <ul>
            ...
            <ul class="list-right">
              <li class="nav-link dropdown">
                <a href="javascript:void(0)" class="btn-resultonline">Informes Ocupacional</a>
                <ul>
          ...
          <div class="row">
            ...
            <div class="col-lg-2 col-md-3 footer-links">
              ...
              <ul>
                ...
                <li><i class="bx bx-chevron-right"></i> <a href="index.php?view=home#ocupacional">Salud Ocupacional</a></li>
              </ul>
            </div>
            ...
            <div class="col-lg-3 col-md-3 footer-links">
              ...
              <ul>
                ...
                <li><i class="bx bx-chevron-right"></i> <a href="index.php?view=blogs">Blogs</a></li>
                <li><i class="bx bx-chevron-right"></i> <a href="index.php?view=campanas">Campañas</a></li>
                <li><i class="bx bx-chevron-right"></i> <a href="index.php?view=home#promociones">Promociones</a></li>
                <li><i class="bx bx-chevron-right"></i> <a href="index.php?view=productos-farmacia">Productos Farmacia</a></li>
              </ul>
            </div>
        ...
        <div class="row mt-4">
          <div class="col-lg-6">
            <nav class="navbar-right">
              <ul>
                ...
                <li><a class="nav-link" href="index.php?view=home#sedes">Sedes</a></li>
              ...
              <ul>
                ...
                <li><a class="nav-link" href="index.php?view=home#ocupacional">Salud Ocupacional</a></li>
                <li class="dropdown">
                  <a href="javascript:void(0)">Informes Ocupacional</a>
                  <ul>
                ...
                <li><a class="nav-link" href="index.php?view=productos-farmacia">Promociones</a></li>
                <li><a class="nav-link" href="index.php?view=home#contact">Cotizar protocolo</a></li>
              </ul>  
              
              <ul>                
                <li class="title-menu">Informes Ocupacional</li>
                <li><a class="nav-link" target="_blank" href="http://www.famisalud.com.pe/ClientesMiraflores">Lima</a></li>
                <li><a class="nav-link" target="_blank" href="http://www.famisalud.com.pe/clienteschincha"><span>Chincha</span></a>
                <li><a class="nav-link" target="_blank" href="http://www.famisalud.com.pe/clientespisco"><span>Pisco</span></a>
                </li>
          ...
          <nav class="navbar-right">                
              <ul>                
                ...
                <li><a class="nav-link" href="index.php?view=blogs">Blogs</a></li>
                <li><a class="nav-link" href="index.php?view=campanas">Campañas</a></li>
              </ul>         
              <ul>                
                <li class="title-menu">Emergencias</li>
              ...
              <ul>                
                ...
                <li><a class="nav-link" href="index.php?view=terminos-condiciones">Terminos y Condiciones</a></li>
                <li><a class="nav-link" href="index.php?view=politica-privacidad">Politica y Privacidad</a></li>
              </ul>          
            </nav><!-- .navbar -->
          </div>
        </div>
    ...
    $(document).ready(function (){     
      ...
      */
      ...
      function errorPagina(){
        ...
        var arrayURL = ["blogs", "campanas", "especialidades", "home", "politica-privacidad", "sedes", "sedesdetalle", "servicio", "staffmedico", "terminos-condiciones"];
        var valUrl = getParamUrl("view");
        var URLactual = window.location;
        
        let firstFind = arrayURL.find(elem => elem == getParamUrl("view"));
        ...
        if(errorCount >= 10){
          window.location.href = "index.php?view=error-404";          
        }
